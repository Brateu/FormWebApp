      ...
      </div>
      {
        form.published ? (
            <div className='flex items-center gap-5 '>
                ...
                <div className='flex items-center gap-5 border rounded border-[rgb(218,220,224)] bg-white text-blue-500 px-5 py-1.5 hover:bg-blue-50 cursor-pointer'>
                    <Paperclip />
